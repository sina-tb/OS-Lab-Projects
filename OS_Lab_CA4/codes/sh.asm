...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      27:	e8 55 0d 00 00       	call   d81 <open>
...
fork1(void)
{
  ...
  pid = fork();
      41:	e8 f3 0c 00 00       	call   d39 <fork>
  if(pid == -1)
    ...
    wait();
      4f:	e8 f5 0c 00 00       	call   d49 <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
  ...
  pid = fork();
      7c:	e8 b8 0c 00 00       	call   d39 <fork>
  if(pid == -1)
    ...
    panic("fork");
      ...
      96:	50                   	push   %eax
      97:	e8 cd 0c 00 00       	call   d69 <close>
      break;
      9c:	83 c4 10             	add    $0x10,%esp
      9f:	eb b3                	jmp    54 <main+0x54>
  exit();
      a1:	e8 9b 0c 00 00       	call   d41 <exit>
      runcmd(parsecmd(buf));
      ...
      if(chdir(buf+3) < 0)
      d6:	e8 d6 0c 00 00       	call   db1 <chdir>
...
00000150 <panic>:
{
  ...
  exit();
     165:	e8 d7 0b 00 00       	call   d41 <exit>
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     19c:	52                   	push   %edx
     19d:	50                   	push   %eax
     19e:	e8 d6 0b 00 00       	call   d79 <exec>
    ...
    exit();
     1b8:	e8 84 0b 00 00       	call   d41 <exit>
  pid = fork();
     1bd:	e8 77 0b 00 00       	call   d39 <fork>
  if(pid == -1)
    ...
    close(rcmd->fd);
     ...
     1e0:	e8 84 0b 00 00       	call   d69 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     1e5:	59                   	pop    %ecx
     1e6:	58                   	pop    %eax
     1e7:	ff 73 10             	pushl  0x10(%ebx)
     1ea:	ff 73 08             	pushl  0x8(%ebx)
     1ed:	e8 8f 0b 00 00       	call   d81 <open>
  ...
  pid = fork();
     237:	e8 fd 0a 00 00       	call   d39 <fork>
  if(pid == -1)
    ...
    close(p[0]);
     ...
     24b:	e8 19 0b 00 00       	call   d69 <close>
    close(p[1]);
     250:	58                   	pop    %eax
     251:	ff 75 f4             	pushl  -0xc(%ebp)
     254:	e8 10 0b 00 00       	call   d69 <close>
    wait();
     259:	e8 eb 0a 00 00       	call   d49 <wait>
    wait();
     25e:	e8 e6 0a 00 00       	call   d49 <wait>
    break;
     263:	83 c4 10             	add    $0x10,%esp
     266:	e9 4d ff ff ff       	jmp    1b8 <runcmd+0x48>
  pid = fork();
     26b:	e8 c9 0a 00 00       	call   d39 <fork>
  if(pid == -1)
    ...
    wait();
     27d:	e8 c7 0a 00 00       	call   d49 <wait>
    runcmd(lcmd->right);
    ...
    panic("fork");
     ...
     2aa:	6a 00                	push   $0x0
     2ac:	e8 b8 0a 00 00       	call   d69 <close>
      dup(p[0]);
     2b1:	5a                   	pop    %edx
     2b2:	ff 75 f0             	pushl  -0x10(%ebp)
     2b5:	e8 ff 0a 00 00       	call   db9 <dup>
      close(p[0]);
     2ba:	59                   	pop    %ecx
     2bb:	ff 75 f0             	pushl  -0x10(%ebp)
     2be:	e8 a6 0a 00 00       	call   d69 <close>
      close(p[1]);
     2c3:	58                   	pop    %eax
     2c4:	ff 75 f4             	pushl  -0xc(%ebp)
     2c7:	e8 9d 0a 00 00       	call   d69 <close>
      runcmd(pcmd->right);
     2cc:	58                   	pop    %eax
     ...
     2e5:	6a 01                	push   $0x1
     2e7:	e8 7d 0a 00 00       	call   d69 <close>
      dup(p[1]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f4             	pushl  -0xc(%ebp)
     2f0:	e8 c4 0a 00 00       	call   db9 <dup>
      close(p[0]);
     2f5:	58                   	pop    %eax
     ...
     302:	e8 62 0a 00 00       	call   d69 <close>
      runcmd(pcmd->left);
     307:	58                   	pop    %eax
...
00000310 <fork1>:
{
  ...
  pid = fork();
     316:	e8 1e 0a 00 00       	call   d39 <fork>
  if(pid == -1)
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 0c 19 00 00       	push   $0x190c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 0c 19 00 00       	push   $0x190c
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 04 19 00 00       	push   $0x1904
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 0c 19 00 00       	push   $0x190c
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 0c 19 00 00       	push   $0x190c
     ...
     bd8:	89 f3                	mov    %esi,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     bf0:	50                   	push   %eax
     bf1:	6a 00                	push   $0x0
     bf3:	e8 61 01 00 00       	call   d59 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     c5d:	e8 1f 01 00 00       	call   d81 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     c71:	50                   	push   %eax
     c72:	e8 22 01 00 00       	call   d99 <fstat>
  close(fd);
     c77:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     c7a:	89 c6                	mov    %eax,%esi
  close(fd);
     c7c:	e8 e8 00 00 00       	call   d69 <close>
  return r;
...
srand(uint s)
{
  ...
  seed = s;
     ...
     d16:	5d                   	pop    %ebp
  seed = s;
     d17:	a3 14 19 00 00       	mov    %eax,0x1914
}
     d1c:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
     d20:	69 05 14 19 00 00 6d 	imul   $0x41c64e6d,0x1914,%eax
     d27:	4e c6 41 
{
     d2a:	55                   	push   %ebp
  ...
  return seed;
     ...
     d2d:	5d                   	pop    %ebp
    + 12345
     d2e:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
     d33:	a3 14 19 00 00       	mov    %eax,0x1914
}
     d38:	c3                   	ret    
...
00000de9 <sem_acquire>:
SYSCALL(sem_acquire)
     de9:	b8 17 00 00 00       	mov    $0x17,%eax
     dee:	cd 40                	int    $0x40
     df0:	c3                   	ret    

00000df1 <sem_release>:
SYSCALL(sem_release)
     ...
     e29:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
     ...
     e90:	e8 cc fe ff ff       	call   d61 <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
     ...
     f00:	e8 5c fe ff ff       	call   d61 <write>
  ...
  write(fd, &c, 1);
     ...
     f61:	e8 fb fd ff ff       	call   d61 <write>
  ...
  write(fd, &c, 1);
     f7a:	e8 e2 fd ff ff       	call   d61 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    1013:	57                   	push   %edi
    1014:	53                   	push   %ebx
    1015:	e8 47 fd ff ff       	call   d61 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    1067:	e8 f5 fc ff ff       	call   d61 <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1091:	a1 84 19 00 00       	mov    0x1984,%eax
{
  ...
  freep = p;
    10cf:	a3 84 19 00 00       	mov    %eax,0x1984
}
    10d4:	5b                   	pop    %ebx
    10d5:	5e                   	pop    %esi
    10d6:	5f                   	pop    %edi
    ...
    10e6:	72 ce                	jb     10b6 <free+0x26>
{
  ...
  freep = p;
    110a:	a3 84 19 00 00       	mov    %eax,0x1984
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    112c:	8b 15 84 19 00 00    	mov    0x1984,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  return freep;
    119b:	8b 15 84 19 00 00    	mov    0x1984,%edx
    ...
    11c4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    11c7:	89 15 84 19 00 00    	mov    %edx,0x1984
}
    ...
    base.s.ptr = freep = prevp = &base;
    11e0:	c7 05 84 19 00 00 88 	movl   $0x1988,0x1984
    11e7:	19 00 00 
    11ea:	c7 05 88 19 00 00 88 	movl   $0x1988,0x1988
    11f1:	19 00 00 
    base.s.size = 0;
    11f4:	b8 88 19 00 00       	mov    $0x1988,%eax
    11f9:	c7 05 8c 19 00 00 00 	movl   $0x0,0x198c
    1200:	00 00 00 
