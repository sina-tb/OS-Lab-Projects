...
main(int argc, char *argv[])
{
  ...
  exit();
  5c:	e8 90 02 00 00       	call   2f1 <exit>
  61:	66 90                	xchg   %ax,%ax
  63:	66 90                	xchg   %ax,%ax
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
 ...
 188:	89 f3                	mov    %esi,%ebx
{
 ...
 1a0:	50                   	push   %eax
 1a1:	6a 00                	push   $0x0
 1a3:	e8 61 01 00 00       	call   309 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 1f 01 00 00       	call   331 <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 22 01 00 00       	call   349 <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 e8 00 00 00       	call   319 <close>
  return r;
...
srand(uint s)
{
 ...
 2c6:	5d                   	pop    %ebp
  seed = s;
 2c7:	a3 c4 0a 00 00       	mov    %eax,0xac4
}
 2cc:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 2d0:	69 05 c4 0a 00 00 6d 	imul   $0x41c64e6d,0xac4,%eax
 2d7:	4e c6 41 
{
 2da:	55                   	push   %ebp
 ...
 2dd:	5d                   	pop    %ebp
    + 12345
 2de:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 2e3:	a3 c4 0a 00 00       	mov    %eax,0xac4
}
 2e8:	c3                   	ret    
...
00000399 <sem_acquire>:
SYSCALL(sem_acquire)
 399:	b8 17 00 00 00       	mov    $0x17,%eax
 39e:	cd 40                	int    $0x40
 3a0:	c3                   	ret    

000003a1 <sem_release>:
SYSCALL(sem_release)
...
printf(int fd, const char *fmt, ...)
{
 ...
 4b0:	e8 5c fe ff ff       	call   311 <write>
 ...
 511:	e8 fb fd ff ff       	call   311 <write>
 ...
 528:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 52a:	e8 e2 fd ff ff       	call   311 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5c3:	57                   	push   %edi
 5c4:	53                   	push   %ebx
 5c5:	e8 47 fd ff ff       	call   311 <write>
        while(*s != 0){
 ...
 617:	e8 f5 fc ff ff       	call   311 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 72e:	56                   	push   %esi
 72f:	e8 45 fc ff ff       	call   379 <sbrk>
  if(p == (char*)-1)
