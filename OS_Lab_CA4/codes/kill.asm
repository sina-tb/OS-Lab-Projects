...
main(int argc, char **argv)
{
  ...
  38:	e8 d4 02 00 00       	call   311 <kill>
  for(i=1; i<argc; i++)
  3d:	83 c4 10             	add    $0x10,%esp
  40:	39 f3                	cmp    %esi,%ebx
  42:	75 e4                	jne    28 <main+0x28>
  exit();
  44:	e8 98 02 00 00       	call   2e1 <exit>
    printf(2, "usage: kill pid...\n");
  49:	50                   	push   %eax
  4a:	50                   	push   %eax
  ...
  52:	e8 09 04 00 00       	call   460 <printf>
    exit();
  57:	e8 85 02 00 00       	call   2e1 <exit>
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
...
srand(uint s)
{
 ...
 2b6:	5d                   	pop    %ebp
  seed = s;
 2b7:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 2bc:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 2c0:	69 05 c0 0a 00 00 6d 	imul   $0x41c64e6d,0xac0,%eax
 2c7:	4e c6 41 
{
 2ca:	55                   	push   %ebp
 ...
 2ce:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 2d3:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 2d8:	c3                   	ret    
