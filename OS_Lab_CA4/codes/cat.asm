  ...
  21:	83 f8 01             	cmp    $0x1,%eax
{
  ...
  57:	e8 5d 03 00 00       	call   3b9 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 28 03 00 00       	call   391 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	pushl  (%ebx)
  ...
  73:	e8 98 04 00 00       	call   510 <printf>
      exit();
  78:	e8 14 03 00 00       	call   391 <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 05 03 00 00       	call   391 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 01 03 00 00       	call   3b1 <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 df 02 00 00       	call   3a9 <read>
  ...
  fa:	e8 11 04 00 00       	call   510 <printf>
    exit();
  ff:	e8 8d 02 00 00       	call   391 <exit>
 ...
 228:	89 f3                	mov    %esi,%ebx
{
 ...
 240:	50                   	push   %eax
 241:	6a 00                	push   $0x0
 243:	e8 61 01 00 00       	call   3a9 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ad:	e8 1f 01 00 00       	call   3d1 <open>
  if(fd < 0)
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 22 01 00 00       	call   3e9 <fstat>
  close(fd);
 2c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ca:	89 c6                	mov    %eax,%esi
  close(fd);
 2cc:	e8 e8 00 00 00       	call   3b9 <close>
  return r;
...
srand(uint s)
{
 ...
 366:	5d                   	pop    %ebp
  seed = s;
 367:	a3 c4 0b 00 00       	mov    %eax,0xbc4
}
 36c:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 370:	69 05 c4 0b 00 00 6d 	imul   $0x41c64e6d,0xbc4,%eax
 377:	4e c6 41 
{
 37a:	55                   	push   %ebp
 ...
 37d:	5d                   	pop    %ebp
    + 12345
 37e:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 383:	a3 c4 0b 00 00       	mov    %eax,0xbc4
}
 388:	c3                   	ret    
...
00000439 <sem_acquire>:
SYSCALL(sem_acquire)
 439:	b8 17 00 00 00       	mov    $0x17,%eax
 43e:	cd 40                	int    $0x40
 440:	c3                   	ret    

00000441 <sem_release>:
SYSCALL(sem_release)
...
printf(int fd, const char *fmt, ...)
{
 ...
 550:	e8 5c fe ff ff       	call   3b1 <write>
 ...
 5b1:	e8 fb fd ff ff       	call   3b1 <write>
 ...
 663:	57                   	push   %edi
 664:	53                   	push   %ebx
 665:	e8 47 fd ff ff       	call   3b1 <write>
        while(*s != 0){
 ...
 6b7:	e8 f5 fc ff ff       	call   3b1 <write>
        ap++;
 ...
 6e1:	a1 e0 0b 00 00       	mov    0xbe0,%eax
{
 ...
 71d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 71f:	a3 e0 0b 00 00       	mov    %eax,0xbe0
}
 724:	5b                   	pop    %ebx
 725:	5e                   	pop    %esi
 726:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 7e6:	e8 f5 fe ff ff       	call   6e0 <free>
  return freep;
 7eb:	8b 15 e0 0b 00 00    	mov    0xbe0,%edx
 ...
 814:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 817:	89 15 e0 0b 00 00    	mov    %edx,0xbe0
}
 ...
 837:	0b 00 00 
 83a:	c7 05 e4 0b 00 00 e4 	movl   $0xbe4,0xbe4
 841:	0b 00 00 
    base.s.size = 0;
 844:	b8 e4 0b 00 00       	mov    $0xbe4,%eax
 849:	c7 05 e8 0b 00 00 00 	movl   $0x0,0xbe8
 850:	00 00 00 
